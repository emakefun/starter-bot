...
Blockly.Blocks.eb_RGB = {
  init: function(){
	 this.setColour(Blockly.Blocks.starterbot.HUE);
	 this.appendDummyInput("")
         .appendField(Blockly.STARTERBOT_SETRGB)	 
	 	 .appendField(new Blockly.FieldImage("../../media/starterbot/eb_ultrasonic.png", 45, 38))	 
         .appendField(new Blockly.FieldDropdown(STARTERBOT_RGBNUMBER), "RGB")	 
	     .appendField(Blockly.STARTERBOT_RGBCOLOUR)
		 .appendField(new Blockly.FieldDropdown(STARTERBOT_RGBCOLOR), "RGBCOLOR");
	this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);

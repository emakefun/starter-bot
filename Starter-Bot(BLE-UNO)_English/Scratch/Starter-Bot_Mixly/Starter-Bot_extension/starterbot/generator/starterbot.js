...
Blockly.Arduino.eb_servo = function(){
 ...
 var value_servo_degree = Blockly.Arduino.valueToCode(this, 'ServoDegree', Blockly.Arduino.ORDER_ATOMIC);
	     Blockly.Arduino.setups_['setup_eb_servo'] = '\t'+'Ebot.SetServoPin('+value_servo_pin+');\n'
								   +'\t'+'Ebot.mRgbUltrasonic->SetServoBaseDegree('+value_servo_degree+');\n'
								   +'\t'+'Ebot.mRgbUltrasonic->SetServoDegree(90);\n'
 var code = '';
 return code;
};
Blockly.Arduino.eb_servoangle = function(){
 ...
 var code = '	Ebot.mRgbUltrasonic->SetServoDegree('+value_servo_angle+');';
 return code;
};
...
Blockly.Arduino.eb_ultrasonicpin = function(){
 ...
 Blockly.Arduino.setups_['setup_eb_ultrasonicpin'] ='\t'+'Ebot.SetRGBUltrasonicPin('+value_SingPin+','+value_RGBPin+');\n'
 var code = '';
 return code;
};
...
//RGB颜色
Blockly.Arduino.eb_RGB = function(){
	var dropdown_RGB = this.getFieldValue('RGB');
	var dropdown_RGBclor = this.getFieldValue('RGBCOLOR');
	var code = 'Ebot.SetRgbColor('+'(E_RGB_INDEX)'+dropdown_RGB+','+dropdown_RGBclor+');\n'
	return code;
};

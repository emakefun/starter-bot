...
{
  int value = (Speed / 10) * 25.5; //app contol Ebot_speed is 0 ~ 100 ,pwm is 0~255
...
#if ARDUINO > 10609
void StarterBot::Move(int direction = 1)
#else
void StarterBot::Move(int direction)
#endif
{
	if(direction == 1){
		GoForward();
...
#if ARDUINO > 10609
void StarterBot::SetRgbColor(E_RGB_INDEX index = E_RGB_ALL, long Color = RGB_WHITE)
#else
void StarterBot::SetRgbColor(E_RGB_INDEX index, long Color)
#endif
{
...
void StarterBot::SetRgbEffect(E_RGB_INDEX index, long Color, uint8_t effect)
{
    if (mRgbUltrasonic != NULL) {
...
#if ARDUINO > 10609
void StarterBot::SetRgbUltrasonicPin(uint8_t Sing_Pin = EM_SING_PIN, uint8_t Rgb_Pin = EM_RGB_PIN, uint8_t Sevo_Pin = EM_SERVO_PIN)
#else
void StarterBot::SetRgbUltrasonicPin(uint8_t Sing_Pin, uint8_t Rgb_Pin , uint8_t Sevo_Pin)
#endif
{
...
#if ARDUINO > 10609
void StarterBot::SetRGBUltrasonicPin(uint8_t Sing_Pin = EM_SING_PIN, uint8_t Rgb_Pin = EM_RGB_PIN)
#else
void StarterBot::SetRGBUltrasonicPin(uint8_t Sing_Pin, uint8_t Rgb_Pin)
#endif
{
  static bool UltrasonicInit = false;
  if (!UltrasonicInit) {
...
#if ARDUINO > 10609
void StarterBot::SetServoPin(uint8_t Sevo_Pin = EM_SERVO_PIN)
#else
void StarterBot::SetServoPin(uint8_t Sevo_Pin)
#endif
{

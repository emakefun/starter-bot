...
#define EM_NRF24L01_CE 4
#define EM_NRF24L01_CSN 7
#define EM_NRF24L01_MOSI 11
#define EM_NRF24L01_MOSO 12
#define EM_NRF24L01_SCK 13
...
private :
    ...
    ST_PROTOCOL SendData;
     uint8_t Nrf24L01CePin, Nrf24L01CsnPin;
...
public :
	...
	void SetNrf24L01Pin(uint8_t ce = EM_NRF24L01_CE, uint8_t csn = EM_NRF24L01_CSN);

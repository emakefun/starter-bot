...
Ultrasonic::Ultrasonic(byte echo_pin, byte trig_pin, byte servo_pin) //set ultrasonic pin initialization
{
    TrigPin = trig_pin;
    EchoPin = echo_pin;
    ServoPin = servo_pin;
...
Ultrasonic::Ultrasonic(byte echo_pin, byte trig_pin) //set ultrasonic pin initialization
{
    TrigPin = trig_pin;
    EchoPin = echo_pin; 
    pinMode(EchoPin, INPUT);
